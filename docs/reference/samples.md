...
| [`garage_v1beta1_garagebucket.yaml`](https://github.com/rajsinghtech/garage-operator/blob/main/config/samples/garage_v1beta1_garagebucket.yaml) | Quotas, website configuration, key grants, and lifecycle rules |
